            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form  method="POST" action="assureprincipal.php" class="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label><h5>Nom :<?php echo $nomAs ?></h5></label>
                      <input type="hidden" name="nomA" class="form-control" id="exampleInputFirstName" placeholder=" Nom  "value="<?php echo $nomAs ?>">
                    </div>
                    <div class="form-group">
                      <label><h5>prénom : <?php echo $prenomAs ?></h5></label>
                      <input type="hidden" name="prenomA" class="form-control" id="exampleInputFirstName" placeholder=" Nom  "value="<?php echo $prenomAs ?>">
                    </div>
                    <div class="form-group">
                      <label><h5>telephone :  <?php echo $telephoneAs ?></h5></label>
                      <input type="hidden" name="telephoneA" class="form-control" id="exampleInputFirstName" placeholder=" telephone  "value="<?php echo $telephoneAs ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" name="datenaissanceA" class="form-control" id="exampleInputFirstName" placeholder=" Date de naissance  "value="<?php echo $datenaissanceAs ?>">
                    </div>
                    <div class="form-group">
                      <label><h5>Date de souscription :</h5></label>
                      <input type="hidden" name="datesouscriptionA" class="form-control" id="exampleInputFirstName" placeholder=" telephone  "value="<?php echo $datesouscriptionAs ?>">
                    </div>
                    <div class="form-group">
                      <label><h5> Email :</h5></label>
                      <input type="hidden" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" name="emailA" placeholder="Email"value="<?php echo $emailAs ?>">
                    </div>
                    <div class="form-group">
                    <?php while($agence=$resultatAg->fetch()) {  ?>
                      <label><h5> Agence :<?php echo $agence?></h5></label>
                      <input type="hidden" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" name="emailA" placeholder="Email"value="<?php echo $emailAs ?>">
                      <?php } ?>
                    </div>
